  ...
  return (
    <div className="w-64 border-r border-sidebar-border bg-sidebar h-screen flex flex-col fixed left-0 top-0">
      <div className="p-6 border-b border-sidebar-border">
        <h1 className="text-xl font-bold text-sidebar-foreground flex items-baseline gap-2">
          Taysir
          <span lang="ar" dir="rtl" className="text-base font-normal opacity-70">تيسير</span>
        </h1>
      </div>
